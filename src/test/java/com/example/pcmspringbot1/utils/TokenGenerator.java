package com.example.pcmspringbot1.utils;
...
public class TokenGenerator {
    ...
    public void doLoginManual(){
        ...
        req.put("username", CredentialsAdminDefault.ADMIN_USER_NAME);
        req.put("password", CredentialsAdminDefault.ADMIN_PASSWORD);
        Response response;
        try {
